...
class RaizCuadradaTest {
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "csv/ValoresValidos.csv", numLinesToSkip = 1, delimiter = ';') // Archivo csv
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "csv/ValoresInvalidos.csv", numLinesToSkip = 1, delimiter = ';') // Archivo csv
